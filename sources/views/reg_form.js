...
export default class RegFormView extends JetView {
                ...
                rows: [
                    {
                        ...
                        elements: [
                            ...
                            },
                            {
                                ...
                                localId: "userEmail",
                                name: "userEmail",
                                placeholder: _("Type email"),
                                invalidMessage: _("must be Email")
                            },
                            {
                                view: "text",
                                type: "password",
    ...
    regTransform() {
        const _ = this.app.getService("locale")._;
        this.changeForm(_("Registration"), _("Log"), _("Register"), "show");
        this._formIndicate = "reg";
    }

    logTransform() {
        const _ = this.app.getService("locale")._;
        this.changeForm(_("Log-in"), _("Reg"), _("Log-in"), "hide");
